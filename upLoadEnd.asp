...
Else
    ...
    For Each File In Uploader.Files.Items
        ...
        FilePath = "C:\Inetpub\wwwroot\shopgiay\images\product-details\"&File.FileName
        ...
        If FileSys.FileExists(FilePath) then 
            ...
            ' Else Save the file
            File.SaveToDisk "C:\\Inetpub\\wwwroot\\shopgiay\\images\\product-details"
			Response.Write("images/product-details/"&File.FileName)
        end if
    Next
