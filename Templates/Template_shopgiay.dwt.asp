					...
					<div class="col-sm-6">
						<div class="contactinfo">
							<ul class="nav nav-pills">
								<li><a href="#"><i class="fa fa-phone"></i> 01643 456 554</a></li>
								<li><a href="#"><i class="fa fa-envelope"></i> shopgiay3ts@gmail.com</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-6">
...
<li class="dropdown"><a href='#'><i class='fa fa-user'></i> <%=Session.Contents("MM_Username")%></a></li>
<li><a href="<%= MM_Logout %>"><i class='fa fa-sign-out'></i> Đăng xuất</a></li>
<% 
else
Response.Write("<li><a href='login.asp'><i class='fa fa-lock'></i> Đăng nhập / Đăng ký</a></li>")
End if
%>
							</ul>
						</div>
					...
					<div class="col-sm-9">
						...
						<div class="mainmenu pull-left">
							<ul class="nav navbar-nav collapse navbar-collapse">
								<li><a href="/shopgiay" class="active">Trang Chủ</a></li>
                                <li><a href="search.asp">Tìm kiếm</a></li>
								<li><a href="contact-us.asp">Liên hệ</a></li>
							</ul>
						</div>
					</div>
					<div class="col-sm-3">
	...
	</header><!--/header--><!-- TemplateBeginEditable name="slider" --><!-- TemplateEndEditable -->
