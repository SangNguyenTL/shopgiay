					...
					<div class="col-sm-6">
						<div class="social-icons pull-right">
							<ul class="nav nav-pills">
								...
								<li><a href="#"><i class="fa fa-envelope"></i> giaycuatui@gmail.com</a></li>
					...
					<div id="slider-carousel" class="carousel slide" data-ride="carousel">
						...
						<div class="carousel-inner">
							<div class="item active">
								...
								<div class="col-sm-11">
									<img src="../images/home/fashion-980x340.jpg" class="girl img-responsive" alt="" />
					...
					<div class="left-sidebar">
						...
						<div class="brands_products"><!--brands_products-->
							...
							<div class="brands-name">
								<ul class="nav nav-pills nav-stacked">
									...
									<li><a href="#"> <span class="pull-right">(56)</span>Addias</a></li>
									<li><a href="#"> <span class="pull-right">(27)</span>Puma</a></li>
									<li><a href="#"> <span class="pull-right">(32)</span>Reebook</a></li>
									<li><a href="#"> <span class="pull-right">(5)</span>Lining</a></li>
									<li><a href="#"> <span class="pull-right">(9)</span>Asics</a></li>
								</ul>
							</div>
						</div><!--/brands_products-->
						...
						<div class="price-range"><!--price-range-->
							...
							<div class="well text-center">
								 ...
								 <b class="pull-left">200</b> <b class="pull-right">600</b>
							</div>
						</div><!--/price-range-->
								...
								<div class="item active">	
									...
									<div class="col-sm-4">
										<div class="product-image-wrapper">
											<div class="single-products">
												<div class="productinfo text-center">
													<img src="../images/home/W2.png" alt="" />
													<h2>$56</h2>
													<p>Easy Polo Black Edition</p>
													<a href="#" class="btn btn-default add-to-cart"><i class="fa fa-shopping-cart"></i>Thêm vào giỏ hàng</a>
												</div>
